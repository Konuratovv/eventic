...
from apps.profiles.views import ProfileViewSet, FollowOrganizerAPIView, OrganizerListAPIView, FollowEventAPIView, UnFollowOrganizerAPIView, UnFollowEventAPIView, SendResetAPiView, CheckResetCodeAPIView, \
    ChangePasswordAPIVIew, SubscribersUserAPIView, LastViewedEvents, DetailOrganizer
